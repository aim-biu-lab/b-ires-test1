...
export const USER_INFO_FIELD_SCHEMA: GuiFieldDefinition[] = [
  ...
  {
    key: 'consentContent',
    label: 'Consent Content (HTML)',
    description: 'HTML content to display in the consent popup when the link is clicked',
    type: 'textarea',
...
export const EXTERNAL_TASK_CONFIG: StageTypeConfig = {
  ...
  sections: [
    ...
    { id: 'pre_open', label: 'Pre-Open Block', collapsible: true },
  ...
  fields: [
    ...
    {
      key: 'config.pre_open_title',
      label: 'Pre-Open Title',
      description: 'Optional title for the block shown above the Open button',
      type: 'text',
      placeholder: 'Before you begin...',
      section: 'pre_open',
    },
    {
      key: 'config.pre_open_description',
      label: 'Pre-Open Description',
      description: 'Optional description with HTML formatting shown above the Open button',
      type: 'textarea',
      rows: 4,
      placeholder: '<p>Please read the following instructions carefully before opening the task...</p>',
      section: 'pre_open',
    },
    {
      key: 'config.pre_open_block_width',
      label: 'Pre-Open Block Width',
      description: 'Width of the pre-open block (e.g., 60%, 100%, 500px). If not set, uses Block Width.',
      type: 'text',
      placeholder: '60%',
      section: 'pre_open',
    },
    {
      key: 'config.pre_open_confirmation_enabled',
      label: 'Enable Confirmation Checkbox',
      description: 'When enabled, shows a checkbox that must be checked before the Open button becomes clickable',
      type: 'boolean',
      default: false,
      section: 'pre_open',
    },
    {
      key: 'config.pre_open_confirmation_text',
      label: 'Confirmation Text',
      description: 'Custom text for the confirmation checkbox',
      type: 'text',
      default: 'I understand',
      placeholder: 'I have read and understood the instructions',
      showWhen: { field: 'config.pre_open_confirmation_enabled', value: true },
      section: 'pre_open',
    },
    {
